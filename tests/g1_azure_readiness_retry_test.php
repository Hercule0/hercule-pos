...
$checks = [
    ...
    '404 is no longer retryable on the proven validate route' => !str_contains($script, '$status" != "404"'),
    ...
    'diagnostic checks validate route and helper' => str_contains($script, 'public/api/v2/validate.php') && str_contains($script, 'includes/G1ProductionAttestation.php'),
...
echo "PASS G1 Azure readiness + Kudu diagnostic — proven-route=true, bounded=true, evidence=true, rsa-required=true\n";
